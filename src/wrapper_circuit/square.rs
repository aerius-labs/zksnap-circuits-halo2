...
// use crate::state_transition_circuit::utils::generate_random_state_transition_circuit_inputs;
// use crate::state_transition_circuit::StateTransitionCircuit;
// use crate::voter_circuit::utils::generate_random_voter_circuit_inputs;
...
// mod common {
//     use crate::wrapper_circuit::wrapper::common::CircuitExt;
...
//     use crate::{
//         state_transition_circuit::StateTransitionCircuit, voter_circuit::VoterCircuit,
//         wrapper_circuit::wrapper::common::CircuitExt,
//     };
...
//         recursion_pk = ProvingKey::<G1Affine>::read::<BufReader<&[u8]>, BaseCircuitBuilder<Fr>>(
//             recursion_pk_reader,
//             halo2_base::halo2_proofs::SerdeFormat::RawBytesUnchecked,
//             recursion_config.clone(),
//         )
...
//     let snark = recursion::gen_recursion_snark(
//         &recursion_params,
//         &recursion_pk,
//         recursion_config,
//         vec![voter_snark],
