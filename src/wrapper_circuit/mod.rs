...
mod recursion {
    ...
    pub fn gen_recursion_pk(
        ...
        let voter_dummy_snark = gen_dummy_snark::<VoterCircuit<Fr>>(
            voter_params,
            Some(voter_vk),
            voter_config.clone()
        );
...
mod test {
    ...
    use crate::{
        ...
        voter_circuit::{
            utils::generate_random_voter_circuit_inputs,
            VoterCircuit,
            VoterCircuitInput,
        },
    };
    ...
    fn test_recursion() {
        ...
        let voter_circuit = VoterCircuit::new(
            voter_config.clone(),
        ...
        let recursion_pk = recursion::gen_recursion_pk(
            &voter_params,
            &state_transition_params,
            &recursion_params,
            voter_pk.get_vk(),
